...
build_python_file $PACKAGE "scripts/odometry.py"
build_python_file $PACKAGE "scripts/log_odom.py"
build_python_file $PACKAGE "scripts/odom_steering_wheel.py"
