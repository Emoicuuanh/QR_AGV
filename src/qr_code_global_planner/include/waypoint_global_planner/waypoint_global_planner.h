...
private:
  ...
  double
      epsilon_;  //!< distance threshold between two waypoints that signifies the last waypoint
  ...
  agv_msgs::ArrayWaypointsResponse array_waypoints_;
  agv_msgs::DirectionMoveResponse direction_;
  std_stamped_msgs::StringServiceResponse move_direction_data_;

  //flags
  bool
      clear_waypoints_;  //!< flag indicating that the waypoint container must be cleared to start anew
