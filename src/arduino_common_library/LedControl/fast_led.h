...
#define UPDATES_INTERVAL 10 // 1000 / UPDATES_PER_SECOND
...
void FastLedLoop()
{
    ...
    // ChangePalettePeriodically(); // Change effect function

    if (t > tLastUpdateLed and (t - tLastUpdateLed) > UPDATES_INTERVAL)
    {
        tLastUpdateLed = t;
